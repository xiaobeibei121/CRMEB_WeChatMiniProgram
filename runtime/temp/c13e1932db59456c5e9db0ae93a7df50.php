<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:103:"/Users/bpp/Desktop/CRMEB_WeChatMiniProgram/application/admin/view/record/record/user_business_chart.php";i:1555661490;s:86:"/Users/bpp/Desktop/CRMEB_WeChatMiniProgram/application/admin/view/public/container.php";i:1555661490;s:87:"/Users/bpp/Desktop/CRMEB_WeChatMiniProgram/application/admin/view/public/frame_head.php";i:1555661490;s:82:"/Users/bpp/Desktop/CRMEB_WeChatMiniProgram/application/admin/view/public/style.php";i:1555661490;s:89:"/Users/bpp/Desktop/CRMEB_WeChatMiniProgram/application/admin/view/public/frame_footer.php";i:1555661490;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="layui-row layui-col-space15"  id="app">
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">会员积分排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo $limit; ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $vo['nickname']; ?>/<?php echo $vo['phone']; ?></td>
            ...
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">会员余额排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo $limit; ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            <thead>
                            <tr>
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">购物笔数排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo $limit; ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            <thead>
                            <tr>
            ...
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">	购物金额 <span class="layui-badge layui-bg-orange">TOP<?php echo $limit; ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            <thead>
                            <tr>
        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md6">
                <div class="layui-card">
                    <div class="layui-card-header">上月消费排行榜 <span class="layui-badge layui-bg-orange">TOP<?php echo $limit; ?></span></div>
                    <div class="layui-card-body layui-row">
                        <table class="layui-table">
                            <thead>
                                <tr>
